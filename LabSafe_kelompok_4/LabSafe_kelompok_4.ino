#define BLYNK_TEMPLATE_ID "TMPL6EuyOeJHN"
#define BLYNK_TEMPLATE_NAME "project myskill"
#define BLYNK_AUTH_TOKEN "apmNsuoN3a7s-jaaDsEkX6rnvUegGq7h"
...
char ssid[] = "Redmi note";  // Change your Wifi/ Hotspot Name
char pass[] = "21021050";    // Change your Wifi/ Hotspot Password
...
void kirimwa(String pesan) {
  ...
  url = "http://api.callmebot.com/whatsapp.php?phone=6281511748795&text=" + urlencode(pesan) + "&apikey=3432681";
  postData();
}
